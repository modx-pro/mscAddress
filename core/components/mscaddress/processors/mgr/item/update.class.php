...
class mscAddressItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mscaddress_item_err_ns');
        }
...
return 'mscAddressItemUpdateProcessor';
